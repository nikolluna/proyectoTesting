...
<body>	
    ...
    <div class="container mt-5">
        ...
        <form id="sellerForm" action="ControladorRegistroEmpleado" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="sellerName" class="form-label">Nombre</label>
            ...
            <div class="mb-3">
                <label for="sellerLastName" class="form-label">Apellido</label>
                <input type="text" class="form-control" id="sellerLastName" oninput="validateInput(this)" title="El apellido no debe contener números o caracteres especiales." required>
            </div>
  ...
  function validateInputNumeros(input) {
    ...
    <script src="scriptVendedor.js"></script>
</body>
</html>
